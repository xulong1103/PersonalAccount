 ...
 * 新增支出
 */
public class AddExpendActivity extends Activity{
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.getText().toString().equals("")) {
                    Toast.makeText(AddExpendActivity.this, "名称不能为空", Toast.LENGTH_LONG).show();
                    return;
                }
                /** 判断金钱是否为空 **/
                if (money.getText().toString().equals("")) {
                    Toast.makeText(AddExpendActivity.this, "金额不能为空", Toast.LENGTH_LONG).show();
                    return;
                }
                /** 将所有信息封装成一个支出对象 **/
                ...
                /** 新建支出 **/
                boolean flag = accountDB.addExpend(expend);
                /** 判断是否成功 **/
                if (flag) {
                    Toast.makeText(AddExpendActivity.this, "保存成功", Toast.LENGTH_LONG).show();
                    AddExpendActivity.this.finish();
                } else {
                    Toast.makeText(AddExpendActivity.this, "保存失败", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
